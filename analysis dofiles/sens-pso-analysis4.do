/*******************************************************************************
DO FILE NAME:			sens-pso-analysis4.do
...
global filename "sens-pso-analysis4"
...
*******************************************************************************/
* create excel file
putexcel set "${pathResults}/appendix-pso-analysis.xlsx", sheet(sens4) modify

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Sensitivity analysis 4: Association (HR [95% CI]) between psoriasis and severe mental illness: comparing risk of SMI in those with psoriasis to those without (from 2004 onwards) ", bold
