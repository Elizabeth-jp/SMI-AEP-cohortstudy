...
DATASETS CREATED:		main-ecz-analysis-interaction.xls
*******************************************************************************/
/*******************************************************************************
HOUSEKEEPING
*******************************************************************************/
...
global filename "main-ecz-analysis-interaction"
...
* create excel file
putexcel set "${pathResults}/main-ecz-analysis.xlsx", sheet(interaction_sex) modify

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Adjusted hazard ratios (95% CIs) for the association between atopic eczema and severe mental illness, stratified by sex (adjusted for calendar period and Carstairs deprivation).", bold
local ++rowcount 
...
* create excel file
putexcel set "${pathResults}/main-ecz-analysis.xlsx", sheet(interaction_age) modify

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Adjusted hazard ratios (95% CIs) for the association between atopic eczema and severe mental illness, stratified by current age (adjusted for calendar period and Carstairs deprivation).", bold
local ++rowcount 
putexcel A`rowcount'="Fitted to patients with complete data for all variables included in each model and from valid matched sets*"
local ++rowcount
...
* create excel file
putexcel set "${pathResults}/main-ecz-analysis.xlsx", sheet(interaction_calendarperiod) modify

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Adjusted hazard ratios (95% CIs) for the association between atopic eczema and severe mental illness, stratified by calendar period (adjusted for Carstairs deprivation).", bold
local ++rowcount 
putexcel A`rowcount'="Fitted to patients with complete data for all variables included in each model and from valid matched sets*"
local ++rowcount
