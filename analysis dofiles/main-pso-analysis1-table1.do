/*******************************************************************************
DO FILE NAME:			main-pso-analysis1-table1.do
...
global filename "main-pso-analysis-table1"
...
/*******************************************************************************
#1. Open psoriasis main analysis dataset and set up column headers in output file
*******************************************************************************/
...
* create excel file
putexcel set "${pathResults}/main-pso-analysis.xlsx", sheet(baseline_n) modify

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Characteristics of the study population at cohort entry stratified by atopic psoriasis exposure status." 
...
putexcel C`rowcount'="With psoriasis", bold hcenter border(top, thin, black)
putexcel D`rowcount'="Without psoriasis", bold hcenter border(top, thin, black)
...
putexcel set "${pathResults}/main-pso-analysis.xlsx", sheet(baseline_pyar) modify

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Table x. Person-time under follow-up broken down by individual-level characteristics and psoriasis exposure status." 
local ++rowcount // increment row couter variable
...
putexcel A`rowcount'="Individuals can contribute data as both psoriasis exposed and unexposed. Therefore, pyar for exposed/unexposed do not total the whole cohort, as individuals may be included in more than one column."
local ++rowcount
