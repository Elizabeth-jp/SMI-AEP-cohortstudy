/*******************************************************************************
DO FILE NAME:			sens-ecz-analysis4.do
...
TASK:					Sensitivity analysis 4 - Repeat the main analysis restricting
						to individuals entering from 2004 onwards
...
global filename "sens-ecz-analysis4"
...
/*
Identify those joining the cohort from 2004 onwards and preserve matching
*/

keep if indexdate>=(d(01jan2004))
...
*******************************************************************************/
* create excel file
putexcel set "${pathResults}/appendix-ecz-analysis.xlsx", sheet(sens4) modify

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Sensitivity analysis 4: Association (HR [95% CI]) between atopic eczema and severe mental illness: comparing risk of SMI in those with atopic eczema to those without (from 2004 onwards) ", bold
