/*******************************************************************************
DO FILE NAME:			sens-pso-analysis6.do
...
TASK:					Sensitivity analysis 6 - Repeat the main analysis additionally adjusting for ethnicity as a confounder
...
global filename "sens-pso-analysis6"
...
*******************************************************************************/
* create excel file
putexcel set "${pathResults}/appendix-pso-analysis.xlsx", sheet(sens6) modify
