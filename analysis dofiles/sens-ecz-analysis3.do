/*******************************************************************************
DO FILE NAME:			sens-ecz-analysis3.do
...
global filename "sens-ecz-analysis3"
...
*******************************************************************************/
* create excel file
putexcel set "${pathResults}/appendix-ecz-analysis.xlsx", sheet(sens3) modify

* set row count variable
local rowcount=1

* Table title
putexcel A`rowcount'="Sensitivity analysis 3: Association (HR [95% CI]) between atopic eczema and severe mental illness: comparing risk of SMI in those with atopic eczema to those without. ", bold
